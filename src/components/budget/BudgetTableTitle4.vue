    ...
    >
        ...
        <template v-slot:body="props">
            ...
            <q-td key="type" :props="props">
                ...
                <q-chip square color="green" text-color="white">{{ props.row.type }}</q-chip>
        ...
        filterType() {
            ...
            if(this.typeModel) {
                if(this.typeModel == 'Well Rounded') {
                    this.data = this.tempData.filter(a => a.type == 'WR');
                }
                else if(this.typeModel == 'Safe and Healthy'){
                    this.data = this.tempData.filter(a => a.type == 'SH');
                }
                else if(this.typeModel == 'Tech PD') {
                    this.data = this.tempData.filter(a => a.type == 'TPD');
                }
                else{
                    this.data = this.tempData.filter(a => a.type == 'TI');
                }
            }else {
