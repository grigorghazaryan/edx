                                        ...
                                        <q-td colspan="100%" class="p-0">
                                            <div class="row">
                                                <div class="col-md-12 child-table">
                                                    <ToggleTable :update="updateToggleTable" :trayId="activity.teacher.id" :id="props.row.id" />
                                                </div>
                                            </div>
                                        </q-td>
                                    </q-tr>
