                ...
                <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="q-mb-md q-pr-sm">
                                <q-select outlined disabled readonly v-model="selectedStatus" :options="categories" dense />
                            </div>
                        </div>
...
export default {
    ...
    methods: {
        add() {
            ...
            const conf = {
                method: 'POST',
                url: `${config.addDocumentToExistingItem}${this.id}/${this.selectedStatus.id}/teacher`,
                headers: {
    ...
    watch: {
        show(val) {
            ...
            if(val) {
                this.data = []
                this.modelMultiple = []
                console.log('gagagagag', this.selectedDocumentType)
