...
export default {
    ...
    methods: {
        ...
        let activityObj = {
            ...
            approval_type_uni: {
                label: data[i].approval_types ? data[i].approval_types.name : '',
                id: data[i].approval_types ? data[i].approval_types.id : null,
            ...
            is_in_inventory: data[i].details != null && (data[i].details.is_in_inventory ? data[i].details.is_in_inventory : 0),
        ...
        getActivityByType(type, id, limit, page) {
            ...
            const conf = {
                method: 'GET',
                url: config.getActivity + type + '/' + id + '/' + 2 + '?limit=' + limit 
                + '&page=' + page + '&category=4', 
                headers: {
                Accept: 'application/json',
                }
            }
        ...
        getApprovals() {
            ...
            axios(conf).then(res => {
                ...
                console.log('optionsApp optionsApp optionsApp', this.optionsApp)
    ...
    watch: {
        ...
        isShowActivityPopup(val) {
            if(!val) {
                ...
                this.getTrackingCategories(this.tab, 4);
            }
        },
    },
    created() {
