    ...
    >
        ...
        <template v-slot:body="props">
            ...
            <q-td key="type" :props="props" @click="copyRowData(props.rowIndex)">
                ...
                <q-chip square color="green" text-color="white" v-if="props.row.type.label == 'WR'">
                ...
                <q-chip square color="purple" text-color="white" v-else-if="props.row.type.label == 'SH'">
                    {{props.row.type.label}}
                    <q-tooltip 
                        anchor="top middle" self="bottom middle" :offset="[10, 10]"
                        transition-show="flip-right"
                        transition-hide="flip-left"
                    >
                        <strong>Safe and Healthy</strong>
                    </q-tooltip>
                </q-chip>

                <q-chip square color="yellow" text-color="white" v-else-if="props.row.type.label == 'PD'">
                    {{props.row.type.label}}
                    <q-tooltip 
                        anchor="top middle" self="bottom middle" :offset="[10, 10]"
                        transition-show="flip-right"
                        transition-hide="flip-left"
                    >
                        <strong>Tech PD</strong>
                    </q-tooltip>
                </q-chip>

                <q-chip square color="blue" text-color="white" v-else>
                    {{props.row.type.label}}
                    <q-tooltip 
                        anchor="top middle" self="bottom middle" :offset="[10, 10]"
                        transition-show="flip-right"
...
data() {
        ...
        methods: {
          ...
          filterType() {
            ...
            if(this.typeModel) {
                if(this.typeModel == 'Well Rounded') {
                    this.data = this.tempDataX.filter(a => a.type.label == 'WR')
                }
                else if(this.typeModel == 'Safe and Healthy'){
                    this.data = this.tempDataX.filter(a => a.type.label == 'SH');
                }
                else if(this.typeModel == 'Tech PD') {
                    this.data = this.tempDataX.filter(a => a.type.label == 'TPD');
                }
                else{
                    this.data = this.tempDataX.filter(a => a.type.label == 'TI');
                }
            }else {
