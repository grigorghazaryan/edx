                    ...
                    <div class="col-md-4 q-pr-lg">
                        ...
                        <div class="row">
                            <div class="col-md-6 q-pr-sm">
                                ...
                                <q-input prefix="$" class="q-mb-md" outlined type="text" v-model="data[0].amount" dense autofocus />
                                <q-popup-edit v-model="data[0].amount" title="Update amount" buttons>
                                    <q-input prefix="$" class="q-mb-sm" type="text" v-model="data[0].amount" dense outlined autofocus />
                                    <q-input prefix="%" v-model="data[0].percentage"  type="number" outlined  :label="data[0].type_uni.label + ' Percentage' " dense autofocus/>
                                </q-popup-edit>
                            </div>
                            <div class="col-md-6">
                    ...
                    <div class="col-md-12 q-mt-md">
                        <div class="row">
                            ...
                            <div class="col-md-9 q-pl-md">
                                ...
                                <q-input dense outlined type="textarea" v-model="data[0].note" />
