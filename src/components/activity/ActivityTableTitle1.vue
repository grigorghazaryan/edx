    ...
    >
      ...
      <template v-slot:body="props">
        ...
        >
          ...
          > 
              <span @click="editDateOfActivity(props.row)" >{{ props.row.activity_date }} </span>
              <span class="q-ml-sm">
          ...
          <q-td key="type" :props="props" @click="copyRowData(props.rowIndex)">
              ...
              <q-popup-edit v-model="props.row.type_uni" title="Update type" buttons>
                <q-select @input="detectChange(props.rowIndex)" 
                v-model="props.row.type_uni" :options="type1test"/>
              </q-popup-edit>  
          ...
          <q-tr v-show="props.expand" :props="props">
            <q-td colspan="100%">
                ...
                <div class="row">
                    ...
                    <q-input dense outlined type="textarea" v-model="props.row.activity_note" readonly />
