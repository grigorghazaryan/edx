    ...
    >
        ...
        <template v-slot:body="props">
            ...
            <q-td key="type" :props="props" @click="copyRowData(props.rowIndex)">
                ...
                <q-chip square color="green" text-color="white" v-if="props.row.type.label == 'TD'">
                ...
                <q-chip square color="purple" text-color="white" v-else-if="props.row.type.label == 'M'">
                    {{props.row.type.label}}
                    <q-tooltip 
                        anchor="top middle" self="bottom middle" :offset="[10, 10]"
                        transition-show="flip-right"
                ...
                <q-chip square color="yellow" text-color="white" v-else>
                    {{props.row.type.label}}
                    <q-tooltip 
                        anchor="top middle" self="bottom middle" :offset="[10, 10]"
                        transition-show="flip-right"
...
data() {
        ...
        methods: {
          ...
          filterType() {
            ...
            if(this.typeModel) {
                if(this.typeModel == 'TD') {
                    this.data = this.tempDataX.filter(a => a.type.label == 'TD')
                }
                else if(this.typeModel == 'Material'){
                    this.data = this.tempDataX.filter(a => a.type.label == 'M');
                }
                else{
                    this.data = this.tempDataX.filter(a => a.type.label == 'S');
                }
            }else {
