                ...
                <div class="q-pa-md">
                    ...
                    <div class="row">
                        <div class="col-md-11">
                            ...
                            <div class="q-mt-lg">
                                    <q-table hide-bottom class="overflow-auto my-sticky-column-table" :data="internalInvoiceData" :columns="internalInvoiceColumns">
                                        <!-- Table Body -->
...
export default {
    ...
    methods: {
        ...
        filterFn (val, update, abort) {
            ...
            if (val === '') {
                update(() => {
                    this.schoolsOptions = this.schoolsOptionsForFilter
                })
                return
            }
        ...
        getSchools() {
            ...
            this.schoolsOptions = schoolsArr
            this.schoolsOptionsForFilter = schoolsArr
