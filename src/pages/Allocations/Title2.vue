          ...
          <div class="col-md-2 col-sm-12 col-xs-12">
            <q-item style="background-color: #fff" class="q-pa-none q-ml-xs">
              ...
              <q-item-section class="q-ml-none">
                ...
                <q-item-label class="text-dark text-h6 text-weight-bolder"
                  >$ {{ barInfo.materialTotal }}</q-item-label
                >
              </q-item-section>
            </q-item>
          </div>
              ...
              <q-card>
                ...
                <q-card-section>
                  <div class="row">
                    ...
                    <div class="col-sm-6 col-xs-12 q-mb-sm q-pr-sm">
                      <q-input
                        :disable="editedItem.allocation"
                        outlined
                        v-model="editedItem.profDev"
                    ...
                    <div class="col-sm-6 col-xs-12 q-mb-sm q-pr-sm">
                      <q-input
                        :disable="!editedItem.allocation"
                        outlined
                        v-model="editedItem.profDevFinal"
                        label="Professional Dev"
                      />
                    </div>
                    ...
                    <div class="col-sm-6 col-xs-12 q-mb-sm">
                      <q-input
                        :disable="!editedItem.allocation"
                        outlined
                        v-model="editedItem.materialsFinal"
                        label="Materials"
                      />
                    </div>
                    ...
                    <div class="col-12">
                      <q-chip
                        ...
                        color="blue"
                        text-color="white"
                        label="Previous Year PD: $45835.58 Previous Year Materials: $185.38"
                      />
                    </div>
                  </div>
                </q-card-section>
          ...
          >
            ...
            <q-td key="profDev" :props="props">
              ...
              <div class="cursor-pointer">
                $ {{ props.row.professional_development }}
              </div>

              <q-popup-edit
                v-model="props.row.professional_development"
            ...
            <q-td key="grandTotal" :props="props">
              $ {{ (props.row.professional_development - props.row.materials).toFixed(2) }}
            </q-td>
...
export default {
  ...
  methods: {
      ...
      const conf = {
        method: 'GET',
        url: config.filterAllocation + '2?' + url,
        headers: {
          Accept: 'application/json',
        }
      }
      ...
      editAllocation(index) {
          ...
          const data  = {
            ...
            materials: this.editedItem.materials,
            professional_development: this.editedItem.professional_development,
  ...
  created() {
    this.getSchools()
    this.getAllocationByType(2, this.count, this.current)
    this.getAllocationBar(2)
    this.getSchoolYears()
  },
  computed: {
    titleHeader() {
