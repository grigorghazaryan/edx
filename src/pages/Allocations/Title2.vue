        ...
        <template v-slot:body="props">
            <q-tr :props="props" @click="copyRowData(props.rowIndex)" :class="{ 'bg-red-2' : props.row.changed }">
              ...
              <q-td key="profDev" :props="props">
                ...
                <div class="cursor-pointer" v-if="props.row.allocation == 'Final'">$ {{ props.row.profDevFinal }} </div>
                <div class="cursor-pointer" v-else> $ {{ props.row.profDev }} </div>

                <q-popup-edit v-if="props.row.allocation == 'Final'" v-model="props.row.profDevFinal" title="Professional Development" buttons>
                  <q-input  @input="detectChange(props.rowIndex)" type="number" v-model="props.row.profDevFinal" dense autofocus/>
                </q-popup-edit>
                <q-popup-edit v-else v-model="props.row.profDev" title="Professional Development" buttons>
              ...
              <q-td key="materials" :props="props">
                ...
                <div class="cursor-pointer" v-if="props.row.allocation == 'Final'">$ {{ props.row.materialsFinal }} </div>
                <div class="cursor-pointer" v-else> $ {{ props.row.materials }} </div>

                <q-popup-edit v-if="props.row.allocation == 'Final'" v-model="props.row.materialsFinal" title="Materials" buttons>
                  <q-input  @input="detectChange(props.rowIndex)" type="number" v-model="props.row.materialsFinal" dense autofocus/>
                </q-popup-edit>
                <q-popup-edit v-else v-model="props.row.materials" title="Materials" buttons>
                  <q-input  @input="detectChange(props.rowIndex)" type="number" v-model="props.row.materials" dense autofocus/>
                </q-popup-edit>
              ...
              <q-td key="allocation" :props="props">
                ...
                <!-- <q-chip square class="edx-q-chip-button" text-color="orange" v-if="props.row.allocation == 'Preliminary'">Preliminary</q-chip>
      ...
      created() {
        ...
        for(let i=0; i<5; i++) {
          ...
          let obj = {
            ...
            grandTotal: grandTotal,
            allocation: r ? 'Final' : 'Preliminary',
