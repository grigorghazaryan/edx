        ...
        >
            ...
            >
                ...
                <q-td
                    ...
                    :props="props"
                >
                    <div v-if="props.row.allocation_type_id_uni"> {{ props.row.allocation_type_id_uni.label }} </div>

                    <q-popup-edit v-model="props.row.allocation_type_id_uni" title="Founded By" buttons>
                      <q-select outlined dense v-model="props.row.allocation_type_id_uni" 
                      @input="detectChange(props.rowIndex)"
...
export default {
  ...
  methods: {
    ...
    getLicense(id, limit, page) {
        ...
        const conf = {
            method: 'GET',
            url: config.getLicense + '/' + id + '?limit=' + limit + '&page=' + page,
            headers: {
