      ...
      <q-card>
        ...
        <q-tab-panels v-model="tab" animated class="tab-panels-parent">
          ...
          <q-tab-panel name="1" class="q-p-sm">
            <LicenseTableTitle :title="1" :barInfo="barInfo" @final="finalResult"/>
          </q-tab-panel>

          <q-tab-panel name="2" class="q-p-sm">
            <LicenseTableTitle :title="2" :barInfo="barInfo" @final="finalResult"/>
          </q-tab-panel>

          <q-tab-panel name="3" class="q-p-sm">
            <LicenseTableTitle :title="3" :barInfo="barInfo" @final="finalResult"/>
          </q-tab-panel>

          <q-tab-panel name="4" class="q-p-sm">
            <LicenseTableTitle :title="4" :barInfo="barInfo" @final="finalResult"/>
          </q-tab-panel>

          <q-tab-panel name="5" class="q-p-sm">
            <LicenseTableTitle :title="5" :barInfo="barInfo" @final="finalResult"/>
          </q-tab-panel>

          <q-tab-panel name="6" class="q-p-sm">
            <LicenseTableTitle :title="6" :barInfo="barInfo" @final="finalResult"/>
          </q-tab-panel>
