      ...
      <q-card>
        ...
        <q-tab-panels v-model="tab" animated class="tab-panels-parent">
          ...
          <q-tab-panel name="1" class="q-p-sm">
            <ServicesTableTitle :title="1" :barInfo="barInfo" @final="finalResult"/>
          </q-tab-panel>

          <q-tab-panel name="2" class="q-p-sm">
            <ServicesTableTitle :title="2" :barInfo="barInfo" @final="finalResult"/>
          </q-tab-panel>

          <q-tab-panel name="3" class="q-p-sm">
            <ServicesTableTitle :title="3" :barInfo="barInfo" @final="finalResult"/>
          </q-tab-panel>

          <q-tab-panel name="4" class="q-p-sm">
            <ServicesTableTitle :title="4" :barInfo="barInfo" @final="finalResult"/>
          </q-tab-panel>

          <q-tab-panel name="5" class="q-p-sm">
            <ServicesTableTitle :title="5" :barInfo="barInfo" @final="finalResult"/>
          </q-tab-panel>

          <q-tab-panel name="6" class="q-p-sm">
            <ServicesTableTitle :title="6" :barInfo="barInfo" @final="finalResult"/>
          </q-tab-panel>
...
<script>
    ...
    import ServicesTableTitle from '../../components/services/ServicesTableTitle'
